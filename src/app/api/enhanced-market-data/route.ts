...
import { getEnhancedMarketData, hasRealDataSupport, getProviderInfo } from '@/services/enhancedMarketData'
...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = {
      ...marketData,
      hasRealDataSupport: hasRealDataSupport(symbol),
      providerInfo: getProviderInfo(symbol),
      requestParams: {
        symbol,
        days,
        preferReal
