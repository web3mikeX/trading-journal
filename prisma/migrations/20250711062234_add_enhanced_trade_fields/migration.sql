...
INSERT INTO "new_Trade" ("commission", "createdAt", "dataSource", "entryDate", "entryFees", "entryPrice", "exitDate", "exitFees", "exitPrice", "grossPnL", "id", "market", "netPnL", "notes", "quantity", "returnPercent", "riskAmount", "screenshots", "setup", "side", "status", "stopLoss", "strategy", "swap", "symbol", "takeProfit", "updatedAt", "userId") SELECT "commission", "createdAt", "dataSource", "entryDate", "entryFees", "entryPrice", "exitDate", "exitFees", "exitPrice", "grossPnL", "id", "market", "netPnL", "notes", "quantity", "returnPercent", "riskAmount", "screenshots", "setup", "side", "status", "stopLoss", "strategy", "swap", "symbol", "takeProfit", "updatedAt", "userId" FROM "Trade";
DROP TABLE "Trade";
